...
This library depends on the [JJ\_NATURAL](http://github.com/boxer41a/jj_naturals) classes, which adds a class between NUMERIC and the NATURAL\_xxx classes.  Through generic anchors using JJ_NATURAL, the top level class, [jj\_big\_natural.e](./classes/jj_big_natural.e), allows developement and testing with 8-bit numbers instead of 32- or 64-bit numbers, which are too hard to manually trace.
